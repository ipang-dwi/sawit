	...
	<div class="container">
      ...
      <div class="panel panel-primary">
		  ...
		  <div class="panel-heading">Edit Data Gejala</div>
		  				<?php
									$result = $mysqli->query("select * from gejala where id_gejala = ".$_GET['id']."");
									if(!$result){
		  ...
		  <div class="panel-body">
							<form role="form" method="post" action="edit-g.php?id=<?php echo $_GET['id'];?>">
                                    <div class="box-body">
										<div class="form-group">
                                            <label for="penyakit">Penyakit</label>
                                            <select class="form-control" name="penyakit" id="penyakit">
											<?php 
												$p = $mysqli->query("select * from penyakit");
												if(!$p){
													echo $mysqli->connect_errno." - ".$mysqli->connect_error;
													exit();
												}
												while ($rowi = $p->fetch_assoc()) {
											?>
												<option value='<?php echo $rowi["id_penyakit"];?>' <?php if($row["id_penyakit"]==$rowi["id_penyakit"]) echo "selected";?>><?php echo $rowi["id_penyakit"].'. '.ucwords($rowi["penyakit"]);?></option>
										    <?php
												}
											?>
											</select>
										...
										<div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="gejala" id="gejala" value="<?php echo $row["gejala"];?>" placeholder="Gejala" required >
                                        </div>
										<div class="form-group">
                                            <label for="bobot">Bobot / CF Pakar</label>
                                            <input type="text" class="form-control" name="bobot" id="bobot" value="<?php echo $row["bobot"];?>" placeholder="Bobot / CF Pakar" required >
                                        </div>				
                                    </div><!-- /.box-body -->

	...
	<div class="container">
        ...
        <div class="container-fluid">
          ...
          <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              ...
              <li class="active"><a href="penyakit.php">Data Penyakit</a></li>
	  ...
	  <div class="panel panel-primary">
		  ...
		  <div class="panel-heading">Data Penyakit</div>
		    <?php
							$kriteria = $mysqli->query("select * from penyakit");
							if(!$kriteria){
		  ...
		  <div class="panel-body table-responsive">
			...
			<tbody>
										...
										?>
														  <a href="edit-penyakit.php?id=<?php echo $row["id_penyakit"];?>" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i> Edit</a>

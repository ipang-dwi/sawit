	...
	<div class="container">
	  ...
	  <br><br><br>
		<ol class="breadcrumb">
		  <li><a href="index.php">Home</a></li>
		  <li><a href="konsultasi.php">Konsultasi</a></li>
		  <li class="active">Lakukan Konsultasi</li>
		</ol>
      ...
      <div class="panel panel-primary">
		  ...
		  <div class="panel-body">
							<form role="form" method="post" action="add-kon.php">
                                    <div class="box-body">
					Masukkan gejala yang ditemukan pada tanaman kelapa sawit :</br></br>		
						...
						<select class="form-control selectpicker" name="gejala1" id="gejala1" data-live-search="true">
						  <?php 
											...
											?>
												<option data-tokens="<?php echo $row["gejala"];?>" value='<?php echo $row["id_gejala"];?>'><?php echo $row["id_gejala"].'. '.ucwords($row["gejala"]);?></option>
										    <?php
												}
											?>
						</select>
						<select class="form-control selectpicker" name="pilihan1" id="pilihan1" data-live-search="true">
						  <?php 
												...
												while ($row = $p->fetch_assoc()) {
											?>
												<option data-tokens="<?php echo $row["pilihan"];?>" value='<?php echo $row["id_pilihan"];?>'><?php echo ucwords($row["pilihan"]);?></option>
										    <?php
												}
											?>
						</select>	

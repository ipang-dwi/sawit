  ...
  <body>
	...
	<div class="container">
        ...
        <div class="container-fluid">
          ...
          <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
             ...
             <li class="active"><a href="pilihan.php">Data Pilihan</a></li>
	  ...
	  <br><br><br>
		<ol class="breadcrumb">
		  <li><a href="index.php">Home</a></li>
		  <li class="active">Data Pilihan</li>
		</ol>
	  <div id="page-wrapper">
      <div class="row">
      <div class="col-lg-12">
	  <div class="panel panel-primary">
		  ...
		  <div class="panel-heading">Data Pilihan</div>
		    <?php
							$kriteria = $mysqli->query("select * from pilihan");
							if(!$kriteria){
			...
			<tbody>
										<?php
												...
												while ($row = $kriteria->fetch_assoc()) {
													echo '<tr>';
													echo '<td>'.$i++.'.</td>';
													echo '<td>'.ucwords($row["pilihan"]).'</td>';
													echo '<td>'.$row["bobot_pilihan"].'</td>';
													echo '<td><!--a href="#"><i class="fa fa-search"></i></a-->';
										?>
														  <a href="edit-pilihan.php?id=<?php echo $row["id_pilihan"];?>" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i> Edit</a>

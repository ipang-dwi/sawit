	...
	<div class="container">
	  ...
	  <br><br><br>
		<ol class="breadcrumb">
		  <li><a href="index.php">Home</a></li>
		  <li><a href="pilihan.php">Data Pilihan</a></li>
		  <li class="active">Edit Data Pilihan</li>
		</ol>
      <!-- Main component for a primary marketing message or call to action -->
      <div class="panel panel-primary">
		  <!-- Default panel contents -->
		  <div class="panel-heading">Edit Data Pilihan</div>
						<?php
									$result = $mysqli->query("select * from pilihan where id_pilihan = ".$_GET['id']."");
									if(!$result){
		  ...
		  <div class="panel-body">
							<form role="form" method="post" action="edit-pil.php?id=<?php echo $_GET['id'];?>">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="pilihan">Pilihan</label>
                                            <input type="text" class="form-control" name="pilihan" id="pilihan" value="<?php echo $row["pilihan"];?>" placeholder="Pilihan" required >
                                        </div>
					<div class="form-group">
                                            <label for="Nilai CF">Nilai CF</label>
                                            <input type="text" class="form-control" name="bobot" id="bobot" value="<?php echo $row["bobot_pilihan"];?>" placeholder="Nilai CF" required >
                                        </div>
                                    </div><!-- /.box-body -->

	...
	<div class="container">
      ...
      <div class="panel panel-primary">
		  ...
		  <div class="panel-body">
							<form role="form" method="post" action="add-g.php">
                                    <div class="box-body">
										<div class="form-group">
											...
											?>
												<option value='<?php echo $row["id_penyakit"];?>'><?php echo $row["id_penyakit"].'. '.ucwords($row["penyakit"]);?></option>
										    <?php
												}
											?>
											</select>
										...
										<div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="bobot" id="bobot" placeholder="Bobot / CF Pakar" required >
                                        </div>				
                                    </div><!-- /.box-body -->
